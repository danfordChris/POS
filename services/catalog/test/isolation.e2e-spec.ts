...
const ROUTES: [string, string][] = [
  ...
  ['get', `/v1/businesses/${bizA}/products/${p}`],
  ['post', `/v1/businesses/${bizA}/products`],
  ['patch', `/v1/businesses/${bizA}/products/${p}`],
  ['post', `/v1/businesses/${bizA}/products/${p}/deactivate`],
  ['post', `/v1/businesses/${bizA}/products/${p}/image`],
];
...
describe('catalog — cross-tenant isolation', () => {
